...
// Special logic for accomodating a check that has been never tested before (don't alert on that one)
...
workers.alertUserToStatusChange = function(newCheckData){
  ...
  helpers.sendToTelegram(newCheckData.userPhone,msg,function(err){
